...
export default class InventoryData extends Phaser.Events.EventEmitter {
    ...
    useHealthPotion(itemName) {
        if(itemName === 'healthpotion') {
            ...
            this.player.scene.scene.get('PlayerStatusBars').events.emit('potionSplat', healAmount, '#73e600');
        }
    }
    ...
    useManaPotion(itemName) {
        if(itemName === 'manapotion') {
            ...
            this.player.scene.scene.get('PlayerStatusBars').events.emit('potionSplat', manaAmount, '#0073e6');
        }
    }
    ...
    useStaminaPotion(itemName) {
        if(itemName === 'staminapotion') {
            ...
            this.player.scene.scene.get('PlayerStatusBars').events.emit('potionSplat', staminaAmount, '#e6e600');
        }
    }
