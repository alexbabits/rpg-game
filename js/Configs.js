...
const config = {
  ...
  type: Phaser.AUTO,
  parent: 'configs',
  scene:[new StartScreen(gameState), new Map1(gameState), new Map2(gameState), LootDisplay, EquipmentDisplay, InventoryDisplay, PlayerVisualScene, DeathScene, Menu, ControlsScene, new LoadScene(gameState)],
  scale: {zoom:1},
